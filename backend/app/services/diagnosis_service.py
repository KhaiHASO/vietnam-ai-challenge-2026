...
class DiagnosisService:
    ...
    async def create_case(self, request: DiagnosisCaseCreate) -> dict[str, Any]:
        ...
        document = {
            ...
            "original_filename": request.original_filename or (img_filename if request.image_url else None),
            "confidence": request.confidence,
            "agent_logs": request.agent_logs or [],
            "diagnosis_detail": request.diagnosis_detail or {},
            "risk_level": None,
